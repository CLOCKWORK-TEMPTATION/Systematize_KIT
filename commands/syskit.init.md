...
2. **Detect repository context**:
   ...
   - Mirror the `commands/` folder into the selected agent or editor directories only; keep templates and scripts in the external `.Systematize/` workspace companion
